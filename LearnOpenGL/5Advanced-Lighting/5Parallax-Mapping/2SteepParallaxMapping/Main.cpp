...
int main()
{
	...
	GLuint diffuseTexture = loadTexture("path/toy_box_diffuse.png", false, false);
	GLuint normalTexture = loadTexture("path/toy_box_normal.png", false, false);
	GLuint parallaxTexture = loadTexture("path/toy_box_disp.png", false, false);
