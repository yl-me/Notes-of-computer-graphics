...
int main()
{
	...
	*/
	...
	int width, height;
	unsigned char * image = SOIL_load_image("C://Users/lenovo/Desktop/NeHe/NeHe/container.jpg", &width, &height, 0, SOIL_LOAD_RGB);
	...
	image = SOIL_load_image("C://Users/lenovo/Desktop/NeHe/NeHe/awesomeface.png", &width, &height, 0, SOIL_LOAD_RGB);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGB, GL_UNSIGNED_BYTE, image);
	glGenerateMipmap(GL_TEXTURE_2D);   // 自动生成多级渐远纹理
...
//		glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
		...
		glm::mat4 projection;
		projection = glm::perspective(camera.Zoom, (GLfloat)HEIGHT / (GLfloat)WIDTH, 0.1f, 100.0f);
