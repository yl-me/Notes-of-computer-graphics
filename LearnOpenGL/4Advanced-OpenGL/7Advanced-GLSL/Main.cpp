...
int main()
{
	...
	Shader shaderRed("path/UBO.vert", "path/UBO_red.frag");
	Shader shaderYellow("path/UBO.vert", "path/UBO_yellow.frag");
	Shader shaderBlue("path/UBO.vert", "path/UBO_blue.frag");
	Shader shaderGreen("path/UBO.vert", "path/UBO_green.frag");
...
//		glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
		...
		GLint modelLoc = glGetUniformLocation(shaderRed.Program, "model");
		...
		modelLoc = glGetUniformLocation(shaderYellow.Program, "model");
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		modelLoc = glGetUniformLocation(shaderBlue.Program, "model");
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		modelLoc = glGetUniformLocation(shaderGreen.Program, "model");
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		glBindVertexArray(0);
