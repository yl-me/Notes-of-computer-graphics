...
const int num = 50;                                   // (new)
typedef struct Start starts;
struct Start{
    int r, g, b;
    GLfloat dist;
    GLfloat angle;
...
GLfloat tilt = 90.0f;                                 // Tilt view
GLfloat spin;                                         // Spin twinkling starts
...
/******************************************************************************************************************************************/
    ...
    for (loop = 0; loop < num; loop++) { 
        star[loop].angle = 0.0f;                         // Start all the starts at angle zero
...
int DrawGLScene(GLvoid)                                  // Here's where we do all the drawing
{
    ...
    for (loop = 0; loop < num; ++loop) {
        ...
        if (twinkle) {                                   // Twinkling stars enable
