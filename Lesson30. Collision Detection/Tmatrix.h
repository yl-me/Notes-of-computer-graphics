...
public:
    ...
    TMatrix33(double mx00, double mx01, double mx02, double mx10, double mx11, double mx12, 
    ...
    TMatrix33& operator+(const TMatrix33& m) { TMatrix33 tm; return add(*this, m, tm); }
    TMatrix33& operator-(const TMatrix33& m) { TMatrix33 tm; return subtract(*this, m, tm); }
    TMatrix33& operator*(const TMatrix33& m) { TMatrix33 tm;  return multiply(*this, m, tm); }
    TMatrix33& operator*(const double& scale) { TMatrix33 tm; return multiply(*this, scale, tm); }
