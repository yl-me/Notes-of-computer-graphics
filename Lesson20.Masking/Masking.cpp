...
/******************************************************************************************************************************************/
    ...
    if ((TextureImage[0] = LoadBMP("1.bmp")) &&
        ...
        (TextureImage[2] = LoadBMP("3.bmp")) &&
        (TextureImage[3] = LoadBMP("4.bmp")) &&
        (TextureImage[4] = LoadBMP("5.bmp")))
    {
        Status = TRUE;
...
int DrawGLScene(GLvoid)                                  // Here's where we do all the drawing
{
    ...
    if (scene) {
        ...
        glBegin(GL_QUADS);                               // Start drawing A texture quad
        ...
        if (masking) {
            ...
            glBegin(GL_QUADS);                                              // Start drawing A texture quad
            glTexCoord2f(roll + 0.0f, 0.0f); glVertex3f(-1.1f, -1.1f, 0.0f);  // Bottom letf
        ...
        glBindTexture(GL_TEXTURE_2D, texture[2]);        // Scelet the first image texture
        glBegin(GL_QUADS);
