...
TMatrix33::TMatrix33(double mx00, double mx01, double mx02, double mx10, 
...
TMatrix33::TMatrix33(double Phi, double Theta, double Psi)
{
    ...
    _Mx[0][0] = c2 * c3; _Mx[0][1] = -c2 * s3; _Mx[0][2] = s2;
    _Mx[1][0] = s1 * s2 * c3 + c1 * s3; _Mx[1][1] = -s1 * s2 * s3 + c1 * c3; _Mx[1][2] = -s1 * c2;
    _Mx[2][0] = -c1 * s2 * c3 + s1 * s3; _Mx[2][1] = c1 * s2 * s3 + s1 * c3; _Mx[2][2] = c1 * c2;
}
...
std::ostream& TMatrix33::write(std::ostream& out) const
{
    return out << "(" << _Mx[0][0] << "," << _Mx[0][1] << "," << _Mx[0][2] << ")" << std::endl
        << "(" << _Mx[1][0] << "," << _Mx[1][1] << "," << _Mx[1][2] << ")" << std::endl
        << "(" << _Mx[2][0] << "," << _Mx[2][1] << "," << _Mx[2][2] << ")" << std::endl;
}

std::istream& TMatrix33::read(std::istream& in)
{
    char ch;
