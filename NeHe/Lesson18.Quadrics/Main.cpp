...
int DrawGLScene(GLvoid)                                  // Here's where we do all the drawing
{
    ...
    glTranslatef(0.0f, 0.0f, z-10.0f);

    glBindTexture(GL_TEXTURE_2D, texture[filter]);

    glRotatef(xrot+95.0f, 1.0f, 0.0f, 0.0f);
    glRotatef(yrot, 0.0f, 1.0f, 0.0f);

    switch(object) {
    case 0:
        glDrawCube(); break;                             // Cube
    case 1:
        glTranslatef(0.0f, 0.0f, -1.5f);
        gluCylinder(quadratic, 1.0f, 1.0f, 3.0f, 32, 32); break;  // Cylinder
    case 2:
        gluDisk(quadratic, 3.0f, 3.5f, 32, 32); break;            // Disk
    case 3:
        gluSphere(quadratic, 1.3f, 32, 32); break;                // Sphere
    case 4:
        glTranslatef(0.0f, 0.0f, -1.5f);
        gluCylinder(quadratic, 1.0f, 0.0f, 3.0, 32, 32); break;   // Cone
    case 5:
        part1 += p1;
        part2 += p2;
